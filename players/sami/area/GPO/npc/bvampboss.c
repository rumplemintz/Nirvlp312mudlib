...
reset(arg) {
  ...
  set_alias("vampire");
  set_race("demon");
  set_short("Lamont "+HIG+"("+HIK+"Mid Boss"+HIG+")"+NORM+"");
  set_long(
	...
	" right hand. Lamont is one of the 4 servants of Vlad the impaler.\n");
...
init_command("wield grace");
  ...
  set_armor_params("other|water",0,-10,0);
  set_al(-800);
  set_heal(10,10);
  set_ac(55+random(8));
  set_wc(40+random(12));
 ...
 add_spell("claw_swipe",
  ""+HIK+"#MN#'s"+NORM+" claws flays you with "+HIY+"burst"+HIB+" of speed"+NORM+".\n",
