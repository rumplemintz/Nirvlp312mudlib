...
"proper knowledge, you could see things in it",
  ...
  dest_dir=({
    "/players/angel/area/mansion/room/drive.c","hum",
  });
}
...
init() {
  ::init();
if(!present("missy",this_object())) move_object(clone_object("/players/desiree/mobs/missy"),this_object());
