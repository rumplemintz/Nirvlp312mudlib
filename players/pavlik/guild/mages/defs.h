...
#define COMPONENT_IDS ({"leather cord","gemstone","sulfur_powder","heartstone",\
              "silver_needle","onyx_powder","platinum_mirror","tespian orb",\
              "amber rod","granite_powder","spider","orb of souls","light feather", })
