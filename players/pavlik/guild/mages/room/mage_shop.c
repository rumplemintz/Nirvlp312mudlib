...
buy_something(str){
  ...
  {
	obj = clone_object("obj/treasure");
	obj->SetMultipleIds(({"sulfur", "powder", "sulfur powder", }));
        obj->set_id( ACID_COMPONENT_ID );
  ...
  {
	obj = clone_object("obj/treasure");
	obj->SetMultipleIds(({"needle", "silver needle", }));
        obj->set_id ( SDAGGER_COMPONENT_ID );
  ...
  {
	obj = clone_object("obj/treasure");
	obj->SetMultipleIds(({"powder", "onyx powder", "onyx powder", }));
        obj->set_id( ESHIELD_COMPONENT_ID );
  ...
  {
	obj = clone_object("obj/treasure");
	obj->SetMultipleIds(({"mirror", "platinum mirror", }));
        obj->set_id( MIMAGE_COMPONENT_ID );
  ...
  {
	obj = clone_object("obj/treasure");
	obj->SetMultipleIds(({"powder", "granite powder", }));
        obj->set_id( STONESKIN_COMPONENT_ID );
  ...
  {
    obj = clone_object("/obj/treasure");
    obj->SetMultipleIds(({"orb"}));
    obj->set_id( "orb of souls" );
  ...
  {
    obj = clone_object("/obj/treasure");
    obj->SetMultipleIds(({"feather",}));
    obj->set_id( "light feather" );
...
buy_something(string str){
  ...
  switch(str) {
   ...
   case "2":
     ...
     break;
   case "3":
     comp_name = ACID_COMPONENT_ID;
     value = ACID_COMPONENT_COST;
     break;
   case "4":
     comp_name = SUMMON_COMPONENT_ID; 
     value = SUMMON_COMPONENT_COST;
     break;
   case "5":
     comp_name = SDAGGER_COMPONENT_ID;
     value = SDAGGER_COMPONENT_COST;
     break;
   case "6":
     comp_name = ESHIELD_COMPONENT_ID;
     value = ESHIELD_COMPONENT_COST;
     break;
   case "7":
     obj = clone_object("/players/saber/stuff/mbag");
     ...
     break;
   case "8":
     comp_name = MIMAGE_COMPONENT_ID;
     value = MIMAGE_COMPONENT_COST;
     break;
   case "9":
     comp_name = "tespian orb";
     value = 150;
     break;
   case "10":
     comp_name = "amber rod";
     ...
     break;
   case "11":
     comp_name = STONESKIN_COMPONENT_ID;
     value = STONESKIN_COMPONENT_COST;
     break;
   case "12":
     comp_name = "spider";
     ...
     break;
   case "13":
     comp_name = "orb of souls";
     value = 300;
     break;
   case "14":
     comp_name = "light feather";
     value = 1000;
     break;
   case "15":
     obj = clone_object("/players/pavlik/guild/mages/objects/pouch");
  ...
  write("You purchase "+comp_name+" for "+value+" coins.\n");
  if( obj )
    move_object(obj, this_player());
  this_player()->add_money(-value);
  if(!obj )
  {
    guild->add_component( comp_name, 1 );
  }
  return 1;
