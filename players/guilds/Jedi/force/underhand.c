...
reset(arg) {
  ...
  name = "Underhand";
  description = "A mid power strike that uses your wrist rotation to add\n\
                significant force into your attack.\n";
  skill_type = SABER;
  skill_level = 4;
  rank_level = 2;
  atk_flag = 1;
...
main( string str, object jedi, object gob ) {
  ...
  switch(Dam) {
  case 28..100:
    write("You counter your "+( old_attack ? old_attack : "attack")+" with a strong underhand strike.\n");
    break;
  case 17..27:
