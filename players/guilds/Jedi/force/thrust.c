...
reset(arg) {
  ...
  name = "Thrust";
  description = "A mid power strike executed by pulling your lightsaber\n\
                back parallel to the ground and then moving your body\n\
                toward your attacker and using your momemtive to de-\n\
                liver a wicked blow.\n";
  skill_type = SABER;
  skill_level = 6;
  rank_level = 2;
