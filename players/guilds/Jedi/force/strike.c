...
reset(arg) {
  ...
  name = "Strike";
  description = "A quick strike with your lightsaber used to unbalance\n\
                your attacker. A strike is not a strong attack but it \n\
                can setup a stronger attack to be successful.";
  skill_type = SABER;
  skill_level = 2;
  rank_level = 1;
  atk_flag = 1;
