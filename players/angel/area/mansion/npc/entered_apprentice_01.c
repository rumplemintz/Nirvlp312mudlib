/*                                                                    *
 *    File:   /players/angel/area/mansion/npc/entered_apprentice_01.c *
 *    Function:         NPC                                           *
...
man learning the ways of the mason. He is wearing a white leather apron.\n");
  ...
  add_spell("saber","#MN# slices his "+HIY+"M"+HIW+"asonic"+NORM+" "+HIY+"S"+HIW+"aber"+NORM+" through you.\n",
                     "#MN# slices his "+HIY+"M"+HIW+"asonic"+NORM+" "+HIY+"S"+HIW+"aber"+NORM+" through #TN#.\n",
                     30,50,"other|fire");
}
