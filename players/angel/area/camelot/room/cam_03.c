/*                                                                    *
 *    File:             /players/angel/area/camelot/room/cam_03.c     *
 *    Function:         room                                          *
...
"+BROWN+"  This is the edge of town which is the only road that leaves Camelot.\n\
...
southeast and Grim Wood forest lies past that to the east."+NORM+"\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/camelot/room/cam_02",       "west",
    "/players/angel/area/camelot/room/dw_01",        "northeast",
  });
}
