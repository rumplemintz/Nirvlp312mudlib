/*                                                                    *
 *    File:             /players/angel/area/town/room/10thnh.c        *
 *    Function:         room                                          *
...
reset(arg)
{
  ...
  if(arg) return;
  set_light(1);
  short_desc = "10th & North H";
  long_desc =
"    "+HIY+"Tenth and North H street"+NORM+"\n\
...
trees provide plenty of shade for people looking for cover.\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/town/room/10th_country",   "north",
    "/players/angel/area/town/room/10thng",         "south",
    "/players/angel/area/town/room/9thnh",          "west",
  });
}