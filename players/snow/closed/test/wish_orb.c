...
reset() {
	...
	set_long("\n\tYou gaze upon the fabled Orb of Wishes.\n"+
		...
		"\tMisc:\n"+
		"\tcoins, casino chips, or experience.\n\n"+
...
do_wish(string str) {
	...
	if(str != "axe" && str != "sword" && str != "amulet" && str != "coins" && str != "chips" && str != "casino chips" &&
		...
		notify_fail("You may wish for an axe, sword, hammer, dagger, staff, mace, whip,\n"+
					...
					"gauntlets, neckguard, shorts, ring, belt, earring, coins, chips, \n"+
					"or experience.\n");
		return 0;
	}
	...
	if(str == "coins") {
        ...
        if(str == "chips" || str == "casino chips" ) {
          ...
          if( !chips ) {
            ...
            chips->add_chip_value( 100000 + random(50000) );
            write("A bonus of chance is the reward of your wish!\n");
        }
	if(str == "experience") {
