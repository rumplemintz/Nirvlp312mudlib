...
::reset(arg);
  ...
  FileName = "/players/earwax/housing/data/dragnar/room/Dragnar_Walking_Dead_107_8.c";
  RoomNum = 8;
  ...
  get_master();
  items = ({  });
  dest_dir = ({ "/players/earwax/housing/data/dragnar/room/Dragnar_Walking_Dead_107_0.c", "back" });
}
