...
if(stuff == 31){ /*  */
  ...
  set_long(
      "Solaris is an old silver-haired, wrinkled, weathered warrior.\n"+
	  "His powerful aura has has been slashed and empowered by lunar\n"+
	  "and demonic energy emanating from his soul.  Evil haunting \n"+
	  "death rid-in soulless eyes pierce through your soul as his gaze\n"+
	  "catches you looking at him.  Engaging this mere mortal may\n"+
	  "not be the wisest move one has ever made.\n");
...
add_spell(
   ...
   add_spell(
    ...
    33,"7-100+60","other|earth",1); /* The Spell that Makes the Man */
...
init() {
  ...
  if( this_player() && this_player() == attacker_ob ) {
    tell_room(environment(), HIB+"\n\n\n\nSolaris turns and fires a "+NORM+RED+"F I R E B A L L"+NORM+" at "+this_player()->query_name()+"!\n"+NORM);
