...
weapon_hit(object attacker) {
  ...
  /** NEED TO ENSURE STACKING FROM MULTIPLE WEPS NOT POSSIBLE **
    * Need to query armor of the mob and see if another staff ** 
    * is registered and limit the total net effect            **/
  if( mag ) {
