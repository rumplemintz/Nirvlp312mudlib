...
reset(arg){
 if(arg) return;
  ...
  Items = ({ ({ "Poop", 100, "Misc", "/players/mizan/etheriel/items/shitplus.c", 0 }) /** Just a placeholder for index 0 **/
            ...
            ,({ "Elixir of Malice", 1000, "Misc", "/players/eurale/Glade/OBJ/malice.c", "An evil alignment potion." })
            ,({ "Elixir of Virtue", 1000, "Misc", "/players/eurale/Glade/OBJ/virtue.c", "A good alignment potion." })
            ,({ "Scroll of Acumination", 5000, "Misc", "/players/dragnar/SevenSpires/scrolls/acuminate.c", "A Scroll that makes any weapon unbreakable (5 charges)" })
            ,({ "Ice Sphere", 4000, "Heal", "/players/snow/heals/ice_sphere", "A Non-Tox Heal 100x3" }) 
            ,({ "Full Heal", 5000, "Heal", "/players/morgar/spells/full_heal", "A Full Non-Tox Heal" })
            ,({ "Wocket Heal", 8500, "Heal", "/players/wocket/turtleville/OBJ/heal_potion", "A Full Non_Tox Heal with tox reduction" })
            ,({ "Scroll of Vitality", 10000, "Misc", "/players/dragnar/SevenSpires/scrolls/vitality", "A Scroll that grants enhanced health" })
            ,({ "Scroll of Aegis", 12000, "Misc", "/players/dragnar/SevenSpires/scrolls/aegis", "A Scroll of gear enhancement" })
            ,({ "Scroll of Quiescent", 15000, "Misc", "/players/dragnar/SevenSpires/scrolls/quiescent", "A Scroll that freezes a mob in place." })
            ,({ "Savable Bag", 25000, "Misc", "/players/saber/stuff/lr_mbag.c", "A Bag that saves when you quit the game" })
            ,({ "Scroll of Wisdom", 100000, "Misc", "/players/dragnar/SevenSpires/scrolls/wisdom", "A Scroll that grants 45+ min double xp" })
          });
  ...
  call_other(d, "set_long",
    ...
    "either the name of the wizard's area, the name of a guild, or the\n"+
    "item # from the list. To see which areas/guilds he has been to, type:\n"+
